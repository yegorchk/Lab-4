...
if __name__ == '__main__':
      result = get_selected_items_list(stuff_dict, 7)
      result_1 = result
...
#поскольку сумма 0 и выведенная сумма является наибольшей (был использован метод динамического программирования), то для 7 ячеек решения нет